...
def parse_args():
    parser = argparse.ArgumentParser(
        description="macOS keyboard teleoperation for Go2 MuJoCo with EEG event logging.",
    )
...
def main():
    ...
    print("macOS note: grant Accessibility permission to Terminal/iTerm/Python if keyboard input is not detected.")
